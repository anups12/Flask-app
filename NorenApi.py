#  'singleorderstatus':  '/SingleOrdStatus', is added 
...
class NorenApi:
    ...
    def token_setter(self):
        ...
        self.__username = "FA17716"
        self.__password = "Check@1234"
        self.__accountid = "FA17716"
    ...
    #NEWLY ADDED FUNCTION TO GET THE CURRENT STATUS OF A GIVEN ORDER_NO
